...
System.register(['lodash'], function (_export, _context) {
    ...
    var _, _createClass, SensorsPrometheusAppConfigCtrl;
    ...
    return {
        ...
        execute: function () {
            ...
            _export('SensorsPrometheusAppConfigCtrl', SensorsPrometheusAppConfigCtrl = function () {
                function SensorsPrometheusAppConfigCtrl(backendSrv) {
                    var _this = this;

                    _classCallCheck(this, SensorsPrometheusAppConfigCtrl);

                    this.backendSrv = backendSrv;
                    this.datasourceName = 'Sensors Prometheus';
                ...
                _createClass(SensorsPrometheusAppConfigCtrl, [{
                    key: 'preUpdate',
                ...
                return SensorsPrometheusAppConfigCtrl;
            }());

            _export('SensorsPrometheusAppConfigCtrl', SensorsPrometheusAppConfigCtrl);

            SensorsPrometheusAppConfigCtrl.templateUrl = 'components/config.html';
        }
    };
});
