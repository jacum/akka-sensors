...
object Dependencies {
  ...
  object Akka {
    ...
    val deps = Seq(actor, typed, persistence, persistenceTyped, persistenceQuery, persistenceCassandra,
      cluster, clusterTyped, clusterTools, slf4j) ++ Logging.deps
  }

  object Prometheus {
    val hotspot = "io.prometheus" % "simpleclient_hotspot" % "0.15.0"
    val common = "io.prometheus" % "simpleclient_common" % "0.15.0"
  ...
  object TestTools {
    val log = "ch.qos.logback" % "logback-classic" % "1.2.10"
